		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 animate-box">
					<h3>Your Respond</h3>
					<form  method="post" action="Hack.controller.Adminrespond" >
						<%
							String replyid=request.getParameter("emailid");
						%>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" id="subject" class="form-control" name="emailid" value=<%out.print(replyid); %> readonly="readonly">
							</div>
						</div>
