...
<section id="aa-advance-search">
  ...
  <%
  ArrayList<product> list=ProductDao.getProductInfo(category,price);
  %>
          ...
          %>
            <div class="col-md-4">
              <article class="aa-properties-item">
                ...
                <%
                if(Integer.parseInt(t.getProductquantity())==0)
                {
                %>
                 Out of Stock
                 <%
                ...
                <div class="aa-properties-item-content">
                  <div class="aa-properties-info">
                    ...
                    <span><%out.print(t.getProduct_name()); %></span>
                    
                  </div>
                  <div class="aa-properties-about">
                    
                    <p><%out.print(t.getCategory()); %></p>                   
                  </div>
                  <div class="aa-properties-detial">
                    <span class="aa-price">
                      <%out.print("Rs. "+t.getPrice());	%>
                    </span>
                     <a href="result_detail.jsp?&productid=<%=t.getProduct_id()%>" class="aa-secondary-btn">View Details</a>
                  </div>
                </div>
              </article>
            </div>
