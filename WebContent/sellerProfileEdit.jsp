...
<%
 ...
 %>
     ...
     <form action="Hack.controller.selllerProfileUpdate" method="post" enctype="multipart/form-data">
	 <!-- Preloader Start -->
     <div class="preloader">
                 ...
                 <div class="col-md-3">
                   <div class="about-fixed">
                    ...
                    if(user.getPhoto()!=null){
                    	System.out.println("seller image is "+user.getPhoto());
                    %>
                    	...
                    	<div class="row">
                            ...
                            <div class="col-md-12 content-page">
                                ...
                                <h5> PASSWORD:</h5><p><input type="text" value= <%= user.getPassword() %> name="newPassword" ></p>
                                 ...
                                 <h5> FLAT NO:</h5><p><input type="text" value= <%= user.getFlat_no() %> name="newFlatNo" ></p>
                                 <h5> CITY:</h5><p><input type="text" value= <%= user.getCity() %> name="newCity" ></p>
                                <h5> STATE:</h5><p><input type="text" value= <%= user.getState() %> name="newState" ></p>
                                 <h5> PINCODE:</h5><p><input type="text" value= <%= user.getPincode() %> name="newPincode" ></p>
